...
`define REQUEST_SERIAL_DATA_TYPE_PID_READ     `REQUEST_SERIAL_DATA_TYPE_WIDTH'h2
`define REQUEST_SERIAL_DATA_TYPE_READ_ADDRESS `REQUEST_SERIAL_DATA_TYPE_WIDTH'h3
